...
describe('guidance artifacts', () => {
  it('loads the shipped runtime policy artifact', () => {
    ...
    expect(guidance).toContain('canonical project scope id returned by `project ensure`')
  ...
  it('loads the shipped supporting scope guidance artifact', () => {
    ...
    expect(memoryScopeGuidanceResource.description).toContain('Supporting guidance for choosing user or project scope')
    expect(memoryScopeGuidanceResource.description).toContain('canonical project scope ids')
